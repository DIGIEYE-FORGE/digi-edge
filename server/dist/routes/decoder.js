...
exports.createSchema = zod_1.z.object({
    ...
    fnc: (0, utils_1.isBetween)(2, 50),
    description: (0, utils_1.isBetween)(2, 50),
});
exports.updateSchema = exports.createSchema.partial();
var decoderRouter = (0, trpc_1.router)({
    findMany: trpc_1.authProcedure.query(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.default.decoder.findMany()];
    ...
    findUnique: trpc_1.authProcedure.input(zod_1.z.number()).query(function (opts) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    input = opts.input;
                    return [4 /*yield*/, prisma_1.default.decoder.findUnique({ where: { id: input } })];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    }); }),
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prisma_1.default.decoder.create({
                            data: {
                                name: rest.name,
                                fnc: rest.fnc,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prisma_1.default.decoder.update({ where: { id: id }, data: data })];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    }); }),
    delete: trpc_1.authProcedure.input(zod_1.z.number()).mutation(function (opts) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    input = opts.input;
                    return [4 /*yield*/, prisma_1.default.decoder.delete({ where: { id: input } })];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    }); }),
    deleteMany: trpc_1.authProcedure.mutation(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.default.decoder.deleteMany()];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    }); }),
});
exports.default = decoderRouter;
