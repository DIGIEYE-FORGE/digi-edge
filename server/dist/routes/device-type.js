...
var deviceTypeRouter = (0, trpc_1.router)({
    ...
    findUnique: trpc_1.authProcedure.input(zod_1.z.number()).query(function (opts) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    input = opts.input;
                    return [4 /*yield*/, prisma_1.default.deviceType.findUnique({ where: { id: input } })];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    }); }),
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prisma_1.default.deviceType.create({
                            data: {
                                name: rest.name,
                            },
                        })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prisma_1.default.deviceType.update({ where: { id: id }, data: data })];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    }); }),
    delete: trpc_1.authProcedure.input(zod_1.z.number()).mutation(function (opts) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    input = opts.input;
                    return [4 /*yield*/, prisma_1.default.deviceType.delete({ where: { id: input } })];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    }); }),
    deleteMany: trpc_1.authProcedure.mutation(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.default.deviceType.deleteMany()];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    }); }),
});
exports.default = deviceTypeRouter;
